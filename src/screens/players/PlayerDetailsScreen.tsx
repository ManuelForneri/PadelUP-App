  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.playerCategory, { color: colors.primary }]}>{player.category}</Text>
      </View>

      {/* Información del jugador */}
      <View style={[styles.infoContainer, { backgroundColor: colors.card }]}>
        <Text style={[styles.sectionTitle, { color: colors.text }]}>Información del Jugador</Text>
        ...
        <View style={styles.infoRow}>
          <Ionicons name={getHandIcon(player.hand || '')} size={20} color={colors.primary} />
          <Text style={[styles.infoText, { color: colors.text }]}>
        ...
        <View style={styles.infoRow}>
          <Ionicons name={getPositionIcon(player.position || '')} size={20} color={colors.primary} />
          <Text style={[styles.infoText, { color: colors.text }]}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={[styles.infoText, { color: colors.text }]} numberOfLines={1} ellipsizeMode="tail">
            {player.email}
          </Text>
        </View>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={[styles.infoText, { color: colors.text }]}>
            Miembro desde: <Text style={styles.infoValue}>{formatDate(player.createdAt)}</Text>
          </Text>
        </View>
      </View>
